...
async def handle_message():
    ...
    agent = Agent(
      name="Hamna",
      instructions="You are Hamna, a personal assistant. You can answer questions, provide information and give Example(Code) if necessary . For latest information, you can search through websearch tool. Always respond in a helpful and friendly manner",
      tools = [web_search],
