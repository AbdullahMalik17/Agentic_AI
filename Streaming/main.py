...
async def handle_message():
    ...
    msg = "Hello! I am Hamna, your personal assistant. How can I help you today?"
...
async def main(message: cl.Message):
  try :  
    ...
    result =await  Runner.run_screamed(
    ...
    async for event in result.stream_events():
        if event.type == "raw_response_event" and isinstance(event.data, ResposnseTextDeltaEvent):
